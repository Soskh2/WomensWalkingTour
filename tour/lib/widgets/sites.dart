...
class Sites extends StatelessWidget {
              ...
              return GestureDetector(
                  ...
                  child: Card(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          fields[index].image != null && fields[index].image!.isNotEmpty && fields[index].image?[0].url != null 
                            ? Image.network(
                                fields[index].image![0].url!,
                                fit: BoxFit.cover,
                              )
                            : Image.asset(
                                'assets/error_image.png', // Replace with your error image asset
                                fit: BoxFit.cover,
                              ),
                          SizedBox(width: 16),
                          Expanded(
  ...
  Future<List<Field>?> getSites() async {
    ...
    callBack: _listOfFieldsFromJson,
     ...
     onFailureCallbackWithMessage: (errorType, msg) {return null;}
     );
  }  
  ...
  List<Field> fields = (json as List)
      .map((e) {
        print("Item being mapped: ${e['fields']}"); // Check each item being processed
